...
class TransformerModel(nn.Layer):
    ...
    def __init__(self, ntoken, hidden, nhead, nlayers, dropout, mode='finetune'):
        ...
        self.weight_attr1 = paddle.framework.ParamAttr(name="linear_weight1", initializer=paddle.nn.initializer.XavierUniform())
        self.bias_attr1 = paddle.framework.ParamAttr(name="linear_bias1", initializer=paddle.nn.initializer.XavierUniform())
        self.weight_attr2 = paddle.framework.ParamAttr(name="linear_weight2", initializer=paddle.nn.initializer.XavierUniform())
        self.bias_attr2 = paddle.framework.ParamAttr(name="linear_bias2", initializer=paddle.nn.initializer.XavierUniform())
        self.weight_attr3 = paddle.framework.ParamAttr(name="linear_weight3", initializer=paddle.nn.initializer.XavierUniform())
        self.bias_attr3 = paddle.framework.ParamAttr(name="linear_bias3", initializer=paddle.nn.initializer.XavierUniform())
        self.weight_attr4 = paddle.framework.ParamAttr(name="linear_weight4", initializer=paddle.nn.initializer.XavierUniform())
        self.bias_attr4 = paddle.framework.ParamAttr(name="linear_bias4", initializer=paddle.nn.initializer.XavierUniform())
