...
parser.add_argument("--init_parameters_q_encoder", type=str, default='', help='The warmup model for query encoder.')
parser.add_argument("--init_parameters_d_encoder", type=str, default='', help='The warmup model for doc encoder.')
