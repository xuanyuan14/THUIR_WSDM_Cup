...
LastEditTime: 2023-01-09 21:17:21
...
dtrain = xgb.DMatrix('/home/lht/wsdm_cup/lightgbm_ensemble/data/train/finetune_train_w_vaild.txt')

ddev = xgb.DMatrix('/home/lht/wsdm_cup/lightgbm_ensemble/data/valid/valid_f.txt')

dtest = xgb.DMatrix('/home/lht/wsdm_cup/lightgbm_ensemble/data/test/test.txt')



bst = pickle.load(open("/home/lht/swh_xgboost/new_pre-train/model/xgb_l2r_7_453_1000.pkl", "rb"))
...
writer_res = open('/home/lht/swh_xgboost/new_pre-train/xgboost_res/train','w')
